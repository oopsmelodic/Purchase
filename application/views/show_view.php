                                        ...
                                        <div class="col-lg-12 shadow" style="padding:20px 20px 0px 20px;">
                                            <div id="printer">
                                                ...
                                                <div class="form-group col-lg-12">
                                                    <h4 class="col-lg-4"><legend id="user_id" user_id="<?php echo $data['employee_id'] ?>"><span class="label label-default">Requestor:</span>  <?php echo $data['fullname']; ?> </legend></h4>
                                                ...
                                                <div class="col-lg-12 form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <h4 class="col-lg-6"><span class="label label-default">Approved by:</span></h4>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-12">
                                                        <h3 class="col-lg-6"><span class="label label-default"> Description: </span></h3>
                                                        <div class="col-lg-12">
