...
//                " Where (" . $user_id ." in (Select employee_id From sign_chain Where iom_id=" . $iom_id . ") AND im.id=" . $iom_id . ") or (im.employee_id= " . $user_id ." AND im.id= " . $iom_id . ")".
                " Where im.id=". $iom_id.
                " Limit 1;"; // Учавствует ли пользователь в создании заявки
